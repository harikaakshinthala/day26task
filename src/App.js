...
const[formdata,setformdata]=useState(formvalues)
 ...
 async function  getuser(){
  ...
  const response=await axios.get('https://64eb2855e51e1e82c5770916.mockapi.io/users');
...
const onpop=(id)=>{
 ...
 const abc= user.filter((row) => row.id === id)[0];
  ...
  const ondel=async(id)=>{
   ...
   const res=await axios.delete(`https://64eb2855e51e1e82c5770916.mockapi.io/users/${id}`)
  ...
  const Handelsumbit=async(e)=>{
    ...
    if(formdata.id){
             ...
             const response=await axios.put(`https://64eb2855e51e1e82c5770916.mockapi.io/users/${formdata.id}`,{
        name:formdata.name,
        age:formdata.age,
     ...
     const res=await axios.post("https://64eb2855e51e1e82c5770916.mockapi.io/users",{
      name:formdata.name,
      age:formdata.age,
      email:formdata.email,
      gender:formdata.gender,
  ...
  return (  
    <>
    <h1 style={{backgroundColor:"yellowgreen",border:"10px 10px",textAlign:"center",padding:"20px"}}>CRUD APP</h1>
    <h1>User Form</h1>
    <Box
      component="form"
      sx={{
